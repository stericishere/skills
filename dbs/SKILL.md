...
| 用户意图信号 | 路由到 | 一句话说明 |
|---|---|---|
| 带着具体商业问题、想看商业模式、说"我有个问题" | Read `~/.claude/skills/dbs/archive/dbs-diagnosis/SKILL.md` | 商业模式诊断，消解问题优先于回答问题 |
| 想找对标、想模仿谁、说"我该学谁" | Read `~/.claude/skills/dbs/archive/dbs-benchmark/SKILL.md` | 对标分析，五重过滤排除一切噪音 |
| 选题通过了想知道怎么做内容、说"这个内容怎么做" | Read `~/.claude/skills/dbs/archive/dbs-content/SKILL.md` | 内容创作诊断，五维检测 |
| 知道该做什么但做不动、说"我总是拖延" | Read `~/.claude/skills/dbs/archive/dbs-unblock/SKILL.md` | 执行力诊断，阿德勒框架找到真正原因 |
| 某个概念搞不清楚、说"这个词什么意思" | Read `~/.claude/skills/dbs/archive/dbs-deconstruct/SKILL.md` | 概念拆解，维特根斯坦式审查 |
